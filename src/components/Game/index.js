...
const TabItem = props => {
  ...
  let BorderColor
  if (isActive === true) {
    BorderColor = `tabButton active`
  } else {
    BorderColor = 'tabButton'
  }
  return (
    <li className="listItem">
      <button className={BorderColor} type="button" onClick={TabClicked}>
        {displayText}
      </button>
    </li>
  )
...
class Matchgame extends Component {
  ...
  render() {
    ...
    const thumbnails = initialImagesList.filter(
